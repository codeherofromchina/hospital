    ...
    extends Service
{
    ...
    private final static QName REGISTRATIONSERVICE_QNAME = new QName("http://tempuri.org", "RegistrationService");
     ...
     * 
     * @return
     *     returns RegistrationServiceSoap
     */
    @WebEndpoint(name = "RegistrationServiceSoap")
    public RegistrationServiceSoap getRegistrationServiceSoap() {
        return super.getPort(new QName("http://tempuri.org", "RegistrationServiceSoap"), RegistrationServiceSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "RegistrationServiceSoap")
    public RegistrationServiceSoap getRegistrationServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org", "RegistrationServiceSoap"), RegistrationServiceSoap.class, features);
    }
